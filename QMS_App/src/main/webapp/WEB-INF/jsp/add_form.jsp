      ...
      <tr>
        <td valign="top" align="left">
            ...
            <tr class="row1">
               ...
               <td valign="middle" align="right" class="input_txt" width="15%"><span class="err">*</span>Auto Number:</td>
               <td valign="top" align="left" class="input_txt1" width="15%">
               <input type="text" value="" id="auto_number" class="input_txtbx145" style="height:22px;background-color:lightgrey;width:50px;border:none;" name="document_id"/><br/><span class="err"></span></td>
           ...
           <td valign="top" align="left" class="input_txt" width="20%"></td>
             ...
             <tr class="row1">
               ...
               <input type="hidden" name="document_id_hidden"  class="input_txtbx1" style="width:200px;" value="<c:out value="${id }"/>"/><input type="text" value="" id="document_id" class="input_txtbx145" style="height:22px;background-color:lightgrey;width:50px;border:none;" name="document_id"/><br/><span class="err"></span></td>
               <td valign="middle" align="right" class="input_txt" width="20%"><span class="err">*</span>Media Type:</td>
               <td valign="top" align="left" class="input_txt" width="20%">
           ...
           <td valign="top" align="left" class="input_txt" width="20%"></td>
              ...
              <tr class="row2">
               ...
               <td valign="top" align="left" class="input_txt" width="20%"><input type="text" name="form_or_record_title" class="input_txtbx1"  style="width:200px;" value="${documentMain.document_title}"/><br/><span class="err"><form:errors path="DocumentMain.document_title"></form:errors></span></td>
