					...
					<div>
						<ul class="horizmenu">
							...
							<li
								...
								<a href="add_nonconformance"
								class="<c:choose><c:when test="${true}">select</c:when><c:otherwise></c:otherwise></c:choose>">
									<span>Add nonconformance</span> </a></li>

							<li
								style="float: left; margin-right: 8px; text-transform: uppercase;">
								<a href="view_nonconformance"
								class="<c:choose><c:when test="${true}">select</c:when><c:otherwise></c:otherwise></c:choose>"
								rel="ddsubmenu1"> <span>View nonconformance</span> </a></li>
						</ul>
					</div></td>
			</tr>
			<tr>
