...
<form method="post" action="add_maintenance">
  ...
  <ul class="horizmenu">
    ...
    <div class="contentbox">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr class="row2">
                  <td valign="middle" align="left" class="input_txt" width="70%"><span class="err">*</span>Equipment Id :</td>
                  <td valign="top" align="right" class="input_txt" width="70%"><input type="text" name="equipment_id" class="input_txtbx1" id="equipment_id" onblur="toggle(this.value)"onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value="" /><span class="err"><form:errors path="Maintenance.equipment_id"></form:errors></span></td>
                </tr>
                 <tr class="row1">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Equipment Name :</td>
                 ...
                 <tr class="row2">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Equipment Model :</td>
                 ...
                 <tr class="row1">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Serial Number :</td>
    ...
    <table>
          <tr class="row2">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Equipment Id :</td>
                  <td valign="top" align="right" class="input_txt" width="70%"><input type="text" name="equipmentid" class="input_txtbx1" id="equipmentid" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value="" /><span class="err"></span></td>
                </tr> 
               <tr class="row1">
                ...
                <br/><span class="err"></span></td>
                   ...
                   <tr class="row2">
                  <td valign="middle" align="left" class="input_txt" width="50%"><span class="err">*</span>Maintenance Frequency :</td>
                 ...
                 <tr class="row1">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Reference :</td>
               ...
               <td valign="middle" align="left" class="input_txt"><span class="err">*</span>Instructions:</td>
           ...
           <table>
            ...
            <tr class="row1">
                ...
                <tr class="row1">
                  <td valign="middle" align="left" class="input_txt" width="30%"><span class="err">*</span>Completed By :</td>
               ...
               <td valign="middle" align="left" class="input_txt"><span class="err">*</span>Notes:</td>
